...
class ControlPanel extends Controller
{
	...
	public function updateinfo()
	{
		...
		{
			$result = $this->getView()->loadAnyTemplate('admin:com_admintools/ControlPanel/updateinfo', [
				'updateInfo'     => $updateInfo,
				'softwareName'   => 'Admin Tools',
				'currentVersion' => ADMINTOOLS_VERSION,
				'currentDate'    => ADMINTOOLS_DATE,
				'compatibilitySlug'    => '#admintools-compatibility',
			]);
		}
