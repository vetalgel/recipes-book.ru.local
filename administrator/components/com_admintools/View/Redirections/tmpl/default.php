...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="akeeba-form">
	...
	<table class="akeeba-table akeeba-table--striped" id="itemsList">
		...
		<tr>
			<th width="20px">
				<a href="#" onclick="Joomla.tableOrdering('ordering','asc','');return false;" class="hasPopover"
				   title="" data-content="Select to sort by this column" data-placement="top"
				   data-original-title="Ordering"><i class="icon-menu-2"></i></a>
			</th>
			<th width="32">
		...
		if ($this->items):
			...
			foreach ($this->items as $row):
				...
				<tr>
					...
					<td>
						<?php echo Text::_('COM_ADMINTOOLS_REDIRECTION_KEEPURLPARAMS_LBL_' . $keepParams) ?>
					</td>
					<td>
