...
if (!empty($list)) {
    ...
    <div id="<?php echo $uniqued; ?>" class="container-slider sjshopcate_slide">
        <div class="page-top">
            <div class="page-title-categoryslider">
                <span>
                    <?php if( $options->slider_title_text ){
                         echo $options->slider_title_text;
                    } else{
                        echo SJJSCategorySliderHelper::truncate($list['category_parent']['name'], (int)$params->get('cat_title_maxcharacs', 25));
                        } ?>
                </span>
            </div>
                                                    ...
                                                    <div class="item-img-info">
                                                        ...
                                                        <div class="hover-links clearfix">
                                                                ...
                                                                <div class="buttons">
                                                                    ...
                                                                    <a class="button_buy" href="<?php print $item->buy_link?>"><i class="icon_cart"></i></a>
                                                                    <?php }?>
                                                                    <a class="button_detail" href="<?php //print $product->product_link?>"><?php //print _JSHOP_DETAIL?></a>
                                                                    <?php print $item->_tmp_var_buttons;?>
                                                                </div>
                                                                <?php print $item->_tmp_var_bottom_buttons;?>
                                                                <a class="img-zoom" data-rel="prettyPhoto"  title="<?php print htmlspecialchars($item->name);?>" href="<?php print $item->image;?>"></a>
                                                        </div>
                                                            ...
                                                            <?php if ($item->_display_price) { ?>
                                                                <div class="jshop_price">
                                                                    ...
                                                                    <?php if ($item->product_old_price > 0) { ?>
                                                                        ...
                                                                        <span
                                                                            class="old-price"><?php print formatprice($item->product_old_price) . '&nbsp;&nbsp;'; ?></span>
                                                                    <?php } ?>
                        ...
                        <?php foreach ($list['category_tree'] as $cat_tree) { ?>
                            <li>
                                <a href="<?php echo $cat_tree->cat_link; ?>"
                                   title="<?php echo $cat_tree->name; ?>" <?php echo SJJSCategorySliderHelper::parseTarget($params->get('target')); ?>><i class="fa fa-angle-double-right"></i>
