	...
	<div class="ts-wrap">
		...
		<div class="ts-slider-wrap <?php echo $effect; ?>" id="<?php echo $slider_id; ?>"
			...
			<div class="ts-control">
				 ...
				 <a class="ts-ctr-prev ts-ctr" href="#<?php echo $slider_id; ?>" data-jslide="prev"><i class="fa fa-angle-left"></i></a>
				 <?php  } ?>
				 <ul class="ts-ctr-pages">
					  <?php $k = -1; $pags = count($list);
					  for($i=0; $i< $pags; $i++){ $k ++;
						$sel_class = $k == $start  ? " sel" : ""; ?>
						<li><a class="ts-ctr-page <?php echo $sel_class; ?>" href="#<?php echo $slider_id; ?>" data-jslide="<?php echo $k ;?>"></a></li>
					  <?php }?>
				</ul>
				 <?php
				 if((int)$params->get('display_direction_button',1)) {?>
				 <a class="ts-ctr-next ts-ctr" href="#<?php echo $slider_id; ?>" data-jslide="next"><i class="fa fa-angle-right"></i></a>
				 <?php  } ?>
			</div>
			<!--End ts-control-->
