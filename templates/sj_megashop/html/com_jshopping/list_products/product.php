...
<div class="product productitem_<?php print $product->product_id?>">
    <div class="image">
		...
		<div class="hover-links clearfix">
			...
			<div class="buttons">
			    ...
			    <a class="button_buy" href="<?php print $product->buy_link?>"><i class="icon_cart"></i></a>
			    <?php }?>
			...
			<a class="img-zoom" data-rel="prettyPhoto"  title="<?php print htmlspecialchars($product->name);?>" href="<?php print $product->image;?>"></a>
		</div>
        </div>
        <?php }?>
	...
	<?php if ($this->allow_review){?>
        <div class="review_mark"><?php print showMarkStar($product->average_rating);?>
	...
	<?php if ($this->config->show_tax_in_product && $product->tax > 0){?>
        ...
        <div class="buttons">
            <?php if ($product->buy_link){?>
            <a class="button_buy" href="<?php print $product->buy_link?>"><i class="icon_cart"></i><?php print _JSHOP_ADD_TO_CART?></a> &nbsp;
            <?php }?>
            <a class="button_detail" href="<?php //print $product->product_link?>"><?php //print _JSHOP_DETAIL?></a>
            <?php print $product->_tmp_var_buttons;?>
        </div>
