...
<div class="block_sorting_count_to_page">
    <?php if ($this->config->show_sort_product){?>
        <span class="box_products_sorting"><?php print _JSHOP_ORDER_BY.": "?><span class="wrap-inputbox"><?php print $this->sorting ?></span><img src="<?php print $this->path_image_sorting_dir?>" alt="orderby" onclick="submitListProductFilterSortDirection()" /></span>
    <?php }?>
    <span class="pagination"><?php print $this->pagination?></span>
    <?php if ($this->config->show_count_select_products){?>
        <span class="box_products_count_to_page"><?php print _JSHOP_DISPLAY_NUMBER.": "?><span class="wrap-inputbox"><?php print $this->product_count?></span> <?php print _JSHOP_DISPLAY_NUMBER_AFTER ?></span>
    <?php }?>
</div>
<?php }?>
