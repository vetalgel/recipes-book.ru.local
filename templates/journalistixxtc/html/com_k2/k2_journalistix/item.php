...
<?php if ($this->item->params->get('itemDateCreated') || $this->item->params->get('itemTitle') || $this->item->params->get('itemAuthor')): ?>
...
<div class="itemHeader">
    ...
    <?php if ($this->item->params->get('itemDateCreated')): ?>
        ...
        <div class="badgeWrap">
            <acronym class="published" title="<?php echo ''; ?>">
                <span class="badgeDay"><?php echo $dd; ?></span>
                <span class="badgeMonth"><?php echo $month[$mm]; ?></span>
    ...
    <?php if ($this->item->params->get('itemTitle')): ?>
        ...
        <?php if ($this->item->params->get('itemAuthor') || $this->item->params->get('itemHits') || $this->item->params->get('itemTwitterLink') || $this->item->params->get('itemCategory') || $this->item->params->get('itemTags')): ?>
        <div style="width:100%;">
            <?php if ($this->item->params->get('itemAuthor')): ?>
                <div style="float:left;width:20%;">
                    ...
                    <span class="itemAuthor">
                        ...
                        <span class="itemHitsTwitterSep">|</span></span>

                </div>
            <?php endif; ?>
        

        <?php if ($this->item->params->get('itemHits') || $this->item->params->get('itemTwitterLink') || $this->item->params->get('itemCategory') || $this->item->params->get('itemTags')): ?>
...
<div class="clr"></div>
        ...
        <div class="itemBody">
            ...
            <?php if ($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
                ...
                <div class="itemImageBlock">
                    <div class="itemImageBlock1"  style="width:<?php echo $this->item->imageWidth + 16; ?>px; float:left;">
        ...
        if (!empty($this->item->image_caption))
            echo $this->item->image_caption; else
        ...
        <?php if ($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)): ?>
                        ...
                        <div class="itemImageGallery"  style="float:none;margin-left:<?php echo $this->item->imageWidth + 25; ?>px;">
    ...
    <?php if ($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
            ...
            <?php if ($this->item->params->get('itemFontResizer')): ?>
                            ...
                            <div class="toolbarItem">
                                    ...
                                    <a class="link" href="<?php echo $this->item->printLink; ?>" onclick="window.print();return false;">
                                    <?php echo JText::_('Print'); ?>
                                    </a>		
                                    <?php else: ?>
                                    <a class="modal link" href="<?php echo $this->item->printLink; ?>" rel="{handler:'iframe',size:{x:900,y:500}}">
                                    <?php echo JText::_('Print'); ?>
                                    </a>
                            <?php endif; ?>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="toolbarItem">
                                <a class="link" onclick="window.open(this.href,'win2','width=400,height=350,menubar=yes,resizable=yes'); return false;" href="<?php echo $this->item->emailLink; ?>">
            ...
            <?php if ($this->item->params->get('itemVideoAnchor') && !empty($this->item->video)): ?>
                            <div class="toolbarItem">
                                <a class="link" href="<?php echo $this->item->link; ?>#itemVideoAnchor"><?php echo JText::_('Video'); ?></a>
                            </div>
                        <?php endif; ?>

            <?php if ($this->item->params->get('itemImageGalleryAnchor') && !empty($this->item->gallery)): ?>
                            <div class="toolbarItem">
                                <a class="link" href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor"><?php echo JText::_('Image Gallery'); ?></a>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="toolbarItem">
                                <?php echo $this->item->event->K2CommentsCounter; ?>
                                    <?php if (empty($this->item->event->K2CommentsCounter)): ?>					
                                        ...
                                        <a class="link" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
        ...
        <?php endif; ?>
            <?php endif; ?>
                ...
                <?php if (!empty($this->item->fulltext)): ?>
                    <?php if ($this->item->params->get('itemAuthorLatest') || $this->item->params->get('itemRelated') || $this->item->params->get('itemExtraFields')) { ?>
                    <div class="articlefulltext"  style="width:<?php echo $this->item->imageWidth; ?>px;">
                        <?php } else { ?>
...
<?php endif; ?>
    ...
    <?php endif; ?>
                ...
                <?php if ($this->item->params->get('itemAuthorLatest') || $this->item->params->get('itemRelated') || $this->item->params->get('itemExtraFields')): ?>
                <div class="latest"  style="margin-left:<?php echo $this->item->imageWidth + 16; ?>px;">
        <?php if ($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
                        <!-- Latest items from author -->

                        <div class="itemAuthorLatest">
                            <span class="item_info"><?php echo JText::_("Latest from"); ?> <?php echo $this->item->author->name; ?></span>
                            <ul>
        ...
        <?php if ($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
                        ...
                        <div class="itemRelated">
                            <span class="item_info"><?php echo JText::_("Related items (by tag)"); ?></span>
                            <ul>
        ...
        <?php if ($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)): ?>
                        ...
                        <div class="itemExtraFields">
                            <span class="item_info"><?php echo JText::_('Additional Info'); ?></span>
                            <ul>
...
if (
    ...
    <?php if ($this->item->numOfComments > 0 && $this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2'))): ?>
        ...
        <?php endif; ?>
            ...
            <!-- Item comments form --><div style="width:100%;">
                <div class="itemCommentsForm" style="float:left;width:80%;">
                    <?php echo $this->loadTemplate('comments_form'); ?>
                </div>
        ...
        <?php if ($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)): ?>
                        <!-- Author Block --><div><div class="itemAuthorDetailsbox">
            ...
            <?php endif; ?>
                                    ...
                                    </div>  	<?php if ($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
