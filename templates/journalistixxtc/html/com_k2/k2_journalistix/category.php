...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			<?php $col=1; $num_col = $this->params->get('num_leading_columns');
				foreach($this->leading as $key=>$item): ?>
			<div class="itemContainerColumn<?php echo $col++; if ($col > $num_col) $col=1; ?>" style="width:<?php echo number_format(100/$num_col,1); ?>%;">
		...
		<div id="itemListPrimary">
			<?php $col=1; $num_col = $this->params->get('num_primary_columns');
			foreach($this->primary as $key=>$item): ?>
			<div class="itemContainer itemContainerColumn<?php echo $col++; if ($col > $num_col) $col=1; ?>" style="width:<?php echo number_format(100/$num_col,1); ?>%;">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
		...
		<div id="itemsListSecondary">
			<?php $col=1; $num_col = $this->params->get('num_secondary_columns');
			foreach($this->secondary as $key=>$item): ?>
			<div class="itemContainer column<?php echo $col++; if ($col > $num_col) $col=1; ?>" style="width:<?php echo number_format(100/$num_col,1); ?>%;">
			<?php
				// Load category_item.php by default
				$this->item=$item;
				echo $this->loadTemplate('item');
		...
		<div id="itemListLinks">
			...
			<?php $col=1; $num_col = $this->params->get('num_links_columns');
