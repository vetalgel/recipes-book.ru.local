...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <?php if($params->get('itemTitle') || $params->get('itemImage') || $params->get('itemIntroText')): ?>
      ...
      <?php if($params->get('itemDateCreated')): ?>
			<div class="clr"></div>
      <span class="moduleItemDateCreated"><?php echo JText::_('K2_WRITTEN_ON') ; ?> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></span>
      <?php endif; ?>
