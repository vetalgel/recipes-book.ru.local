...
<div id="k2Container" class="itemView portfolio-blog<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">

	<div class="clearfix" id="k2Container-inner">
		...
		<div class="itemBody">
			...
			<div class="blog-post-date clearfix">
				<span class="date"><?php echo date('d', strtotime($this->item->created)); ?></span>
				<div class="month-year">
					<span class="month"><?php echo JText::_(strtoupper(date('F', strtotime($this->item->created)))."_SHORT"); ?></span>
					<span class="year"><?php echo date('Y', strtotime( $this->item->created)); ?></span>
				</div>
			</div>
			<?php endif; ?>
