...
<div id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php if($this->params->get('show_page_title') || JRequest::getCmd('task')=='search' || JRequest::getCmd('task')=='date' || count($this->items) && $this->params->get('genericFeedIcon',1) ): ?>
	<!-- Page title -->
	...
	<div class="genericItemList">
		...
		<div class="genericItemView">
			...
			<?php if($this->params->get('genericItemTitle') || $this->params->get('genericItemDateCreated')): ?>
			  ...
			  <?php endif; ?>
				...
				<div class="article-tools clearfix">
					<dl style="width: auto;" class="article-info">
						<!-- Date created -->
						<dd class="create"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?></dd>
					</dl>
				</div>
				<?php endif; ?>
		  </div>
